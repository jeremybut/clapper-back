...
RouteStore.dispatchToken = KoviesAppDispatcher.register(function(payload) {
  KoviesAppDispatcher.waitFor([
    SessionStore.dispatchToken,
    MovieStore.dispatchToken
  ]);
  ...
  switch(action.type) {
    ...
    case ActionTypes.RECEIVE_CREATED_MOVIE:
      router.transitionTo('app');
      break;
